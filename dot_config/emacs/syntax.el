...
(use-package tree-sitter :ensure t
  ...
  (add-to-list 'auto-mode-alist '("\\.jsonnet\\'" . json-ts-mode))
  (add-to-list 'auto-mode-alist '("\\.yaml-cpp\\'" . yaml-ts-mode))
  (add-to-list 'auto-mode-alist '("\\.yml-cpp\\'" . yaml-ts-mode))
  (add-to-list 'auto-mode-alist '("\\.hcl2\\'" . hcl-ts-mode))
  (add-to-list 'auto-mode-alist '("\\.hcl3\\'" . hcl-ts-mode))
  (add-to-list 'auto-mode-alist '("\\.hcl4\\'" . hcl-ts-mode)))
