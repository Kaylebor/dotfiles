...
(use-package undo-fu :ensure t
  :config
  ;; Increase undo limits for modern systems (default is ~160KB/240KB/1.5MB)
...
(with-eval-after-load 'evil
  ...
  ;; Enhanced undo-fu keybindings
  (keymap-set evil-normal-state-map "U" #'undo-fu-only-redo-all)
  (keymap-set evil-visual-state-map "U" #'undo-fu-only-redo-all)
  (keymap-set evil-normal-state-map "g u" #'undo-fu-disable-checkpoint)
  (keymap-set evil-visual-state-map "g u" #'undo-fu-disable-checkpoint))
