;;; claude-code-ide-edit-tools.el --- Code editing and manipulation tools -*- lexical-binding: t; -*-
...
;; Code editing and manipulation tools for Claude Code IDE.
...
(define-mcp-tool comment-region (file-path start-line end-line)
...
(define-mcp-tool indent-region (file-path start-line end-line)
...
(define-mcp-tool yasnippet-list-snippets (&optional mode-name)
...
(define-mcp-tool yasnippet-insert-snippet (file-path line column snippet-key)
...
(provide 'claude-code-ide-edit-tools)
;;; claude-code-ide-edit-tools.el ends here